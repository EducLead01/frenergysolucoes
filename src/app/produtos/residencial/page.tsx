            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="flex-1 flex flex-col gap-5">
                ...
                <h2 className="text-2xl lg:text-3xl font-bold text-[#4D4D4D] leading-snug">
                  ...
                  <span style={{ color: "#FF5900" }}>todo mês</span>
                </h2>
                <p className="text-[#787878] text-base leading-relaxed">
                  Sistemas de 3 a 20 kWp são ideais para casas e apartamentos. Com energia solar, você deixa de pagar à distribuidora e passa a produzir sua própria eletricidade, com retorno garantido em até 4 anos.
                </p>
                <p className="text-[#787878] text-base leading-relaxed">
                  A Frenergy realiza a visita técnica, dimensiona o sistema ideal para o seu perfil de consumo, cuida de toda a documentação e entrega o projeto instalado e funcionando. Você só precisa acompanhar a economia.
                </p>
                <a
                  href="#contato"
          ...
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="text-center mb-12">
              <h2 className="text-2xl lg:text-3xl font-bold text-[#4D4D4D]">
                Vantagens para a{" "}
                <span style={{ color: "#FF5900" }}>sua casa</span>
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  title: "Retorno em até 4 anos",
                  text: "Economia de até 95% na conta de luz desde o primeiro mês, com sistema de 25 anos de vida útil.",
                },
                {
                  icon: (
                  ...
                  text: "Processo rápido e limpo. A instalação é feita em 1 a 2 dias sem grandes intervenções na estrutura.",
                },
                {
                  icon: (
                    <svg width="32" height="32" viewBox="0 0 30 31" fill="none">
                  ...
                  text: "Imóveis com energia solar são avaliados com até 8% a mais no mercado imobiliário.",
                },
              ].map((b, i) => (
