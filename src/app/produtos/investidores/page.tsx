            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="flex-1 relative">
                ...
                <div className="relative rounded-2xl overflow-hidden aspect-[4/3]">
                  <Image
                    src="/images/Investidores.jpg"
                    alt="Investidores em energia solar"
                    fill
              ...
              <div className="flex-1 flex flex-col gap-5">
                ...
                <h2 className="text-2xl lg:text-3xl font-bold text-[#4D4D4D] leading-snug">
                  Seu dinheiro gerando{" "}
                  <span style={{ color: "#FF5900" }}>energia e rentabilidade</span>
                </h2>
                <p className="text-[#787878] text-base leading-relaxed">
                  Investir em usinas solares fotovoltaicas é uma das formas mais seguras e previsíveis de gerar renda passiva no Brasil. Com a Frenergy, você aplica em ativos reais, com retorno garantido por contratos de longo prazo e geração de energia mensurável.
                </p>
                <p className="text-[#787878] text-base leading-relaxed">
                  Nosso modelo conecta investidores a projetos de geração distribuída já licenciados, com engenharia validada e operação monitorada em tempo real. Você investe, a Frenergy opera, e o dinheiro cai na sua conta.
                </p>
                <a
                  href="#contato"
              ...
              {[
                {
                  ...
                  text: "Retorno entre 10% e 18% ao ano, superior à maioria dos investimentos tradicionais de renda fixa.",
                },
                {
                  icon: (
                  ...
                  text: "Receita mensal previsível atrelada à geração de energia, com contratos de 20 a 25 anos.",
                },
                {
                  icon: (
                    <svg width="32" height="32" viewBox="0 0 30 31" fill="none">
                  ...
                  title: "Ativo real e seguro",
                  text: "Você investe em infraestrutura física com geração monitorada e laudos técnicos transparentes.",
                },
              ].map((b, i) => (
