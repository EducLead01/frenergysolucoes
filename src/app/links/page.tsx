...
export default function Links() {
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Conteúdo */}
      <div className="relative z-10 flex flex-col items-center gap-4 w-full max-w-sm px-6 py-16">
        ...
        {links.map((link) => (
          <a
            ...
            className="w-full flex items-center gap-3 px-6 py-4 rounded-2xl font-bold hover:opacity-85"
            style={{
              background: NAVY,
              color: "#fff",
