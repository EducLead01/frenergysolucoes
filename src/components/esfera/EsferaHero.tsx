        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-[#4D4D4D] leading-snug">
              ...
              <span className="text-[#F0416E]">8 mil reais por mês?</span>
            </h2>
            <h3 className="text-xl lg:text-2xl text-[#4D4D4D] leading-relaxed">
              Nós simplificamos para você economizar{" "}
              <span className="font-bold text-[#F0416E]">até 35%</span> na conta de luz.
            </h3>
            <div>
              <a
                href="#contato-esfera"
