            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="flex-1 flex flex-col gap-5">
                ...
                <h2 className="text-2xl lg:text-3xl font-bold text-[#4D4D4D] leading-snug">
                  Grandes indústrias, grandes{" "}
                  <span style={{ color: "#FF5900" }}>economias</span>
                </h2>
                <p className="text-[#787878] text-base leading-relaxed">
                  Para indústrias e grandes consumidores, o custo com energia pode representar 30% ou mais do custo operacional total. Sistemas acima de 75 kWp são projetados sob medida para absorver a demanda industrial com máxima eficiência.
                </p>
                <p className="text-[#787878] text-base leading-relaxed">
                  A Frenergy atua com consultoria energética completa, engenheiro dedicado ao projeto e gestão de todo o processo junto à distribuidora. Sua indústria opera com energia limpa, estável e muito mais barata.
                </p>
                <a
                  href="#contato"
          ...
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="text-center mb-12">
              <h2 className="text-2xl lg:text-3xl font-bold text-[#4D4D4D]">
                Vantagens para a{" "}
                <span style={{ color: "#FF5900" }}>indústria</span>
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  title: "Redução de demanda",
                  text: "Diminua significativamente os custos de demanda contratada e consumo na ponta.",
                },
                {
                  icon: (
                  ...
                  text: "Projeto personalizado com engenheiro exclusivo para sua planta, do dimensionamento à entrega.",
                },
                {
                  icon: (
                    <svg width="32" height="32" viewBox="0 0 30 31" fill="none">
                  ...
                  text: "Homologação completa junto à ANEEL e distribuidora, sem burocracia para sua equipe.",
                },
              ].map((b, i) => (
